...
Additionally computes a Logistic Map using an inputted value for the r axis. Bifurcation can be controlled by the number of iterations inputted by the user.



![alt text]("C:\Users\mahsa\Pictures\LorenzAttractor.png")
